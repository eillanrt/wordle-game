...
$(document).ready(() => {
  ...
  $.ajax(
    'https://raw.githubusercontent.com/eillanrt/wordle-game/main/assets/words.txt'
  ).done((words) => {
  ...
  function getRandomWord() {
    ...
    if (answers === null) {
      $.ajax(
        'https://raw.githubusercontent.com/eillanrt/wordle-game/main/assets/answers.txt'
      ).done((res) => {
        answers = res.split('\n').map((line) => line.trim())
